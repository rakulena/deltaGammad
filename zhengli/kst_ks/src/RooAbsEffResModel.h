...
public:
   ...
   RooAbsEffResModel(const char *name, const char *title, RooAbsRealLValue& convVar);
   //RooAbsEffResModel(const char *name, const char *title, RooRealVar& convVar); // For ROOT v6.18
