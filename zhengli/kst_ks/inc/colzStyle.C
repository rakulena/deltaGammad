...
///////////////////////////////////////////////////////////////////
  ...
  // Line thickness
  Double_t lhcbWidth    = 1.20; // Old LHCb style: 3.00;
  // Text size
  ...
  //Color_t colors[8] = {0,KSpring+10,KSpring+9,KSpring+8,KSpring+7,KSpring+6,KSpring+5,KSpring+4};
  //int colors[8] = {0,5,7,3,6,2,4,1};
  //int colors[8] = {0,1,12,13,9,6,2,4};
  //lhcbStyle->SetPalette(8,colors);
   gStyle->SetPalette(kBird); //kBlueGreenYellow
