...
// Tue Jul 15 07:42:18 2025 by ROOT version 6.32.02
// from TChain /
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/lzufs/user/zhanghy/Sample/mc/Bd2JpsiKstar/Bd2JpsiKstar_2016_MC_selected_fewvars_presel.root/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
...
void massfit::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("h_sum_PT", &h_sum_PT, &b_h_sum_PT);
   Notify();
}
