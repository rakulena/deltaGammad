...
void applyBDT(int year=2016) {
    ...
    std::string inputPath = Form("/lzufs/user/zhanghy/Sample/Train/Bd2JpsiKshort_mc_%s_BDT.root", yearStr.c_str());
    std::string outputPath = Form("/lzufs/user/zhanghy/Sample/afterBDT/after_Bd2JpsiKshort_mc_%s_BDT.root", yearStr.c_str());
