...
// Mon Aug 11 17:44:58 2025 by ROOT version 6.32.02
// from TChain /
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/lzufs/user/zhanghy/Sample/mc/Bd2JpsiKshort/Bd2JpsiKshort_2016_MC_selected_fewvars_presel.root/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
...
void massfit::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("m_ppi", &m_ppi, &b_m_ppi);
   Notify();
}
