...
// Fri Jul 11 16:21:36 2025 by ROOT version 6.32.02
// from TChain /
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Kstar_TRUEID;
   Int_t           Kplus_TRUEID;
   Int_t           Kstar_MC_MOTHER_ID;
   Int_t           Kstar_MC_MOTHER_KEY;
   Int_t           Kstar_MC_GD_MOTHER_ID;
   Int_t           Kstar_MC_GD_MOTHER_KEY;
   Int_t           Kplus_MC_MOTHER_ID;
   Int_t           Kplus_MC_MOTHER_KEY;
   Int_t           Kplus_MC_GD_MOTHER_ID;
   Int_t           Kplus_MC_GD_MOTHER_KEY;
   Double_t        Kplus_ProbNNpi_pidcorr_default;
   Double_t        Kplus_ProbNNpi_pidstat_default;
   Double_t        Kplus_ProbNNpi_pidmcstat_default;
   Double_t        Kplus_ProbNNpi_pidcorr_syst1;
   Double_t        Kplus_ProbNNpi_pidstat_syst1;
   Double_t        Kplus_ProbNNpi_pidmcstat_syst1;
   Double_t        Kplus_ProbNNk_pidcorr_default;
   Double_t        Kplus_ProbNNk_pidstat_default;
   Double_t        Kplus_ProbNNk_pidmcstat_default;
   Double_t        Kplus_ProbNNk_pidcorr_syst1;
   Double_t        Kplus_ProbNNk_pidstat_syst1;
   Double_t        Kplus_ProbNNk_pidmcstat_syst1;
   Double_t        Kplus_ProbNNp_pidcorr_default;
   Double_t        Kplus_ProbNNp_pidstat_default;
   Double_t        Kplus_ProbNNp_pidmcstat_default;
   Double_t        Kplus_ProbNNp_pidcorr_syst1;
   Double_t        Kplus_ProbNNp_pidstat_syst1;
   Double_t        Kplus_ProbNNp_pidmcstat_syst1;
   ...
   TBranch        *b_Kstar_MC_MOTHER_ID;   //!
   TBranch        *b_Kstar_MC_MOTHER_KEY;   //!
   TBranch        *b_Kstar_MC_GD_MOTHER_ID;   //!
   TBranch        *b_Kstar_MC_GD_MOTHER_KEY;   //!
   TBranch        *b_Kplus_MC_MOTHER_ID;   //!
   TBranch        *b_Kplus_MC_MOTHER_KEY;   //!
   TBranch        *b_Kplus_MC_GD_MOTHER_ID;   //!
   TBranch        *b_Kplus_MC_GD_MOTHER_KEY;   //!
   TBranch        *b_Kplus_ProbNNpi_pidcorr_default;   //!
   TBranch        *b_Kplus_ProbNNpi_pidstat_default;   //!
   TBranch        *b_Kplus_ProbNNpi_pidmcstat_default;   //!
   TBranch        *b_Kplus_ProbNNpi_pidcorr_syst1;   //!
   TBranch        *b_Kplus_ProbNNpi_pidstat_syst1;   //!
   TBranch        *b_Kplus_ProbNNpi_pidmcstat_syst1;   //!
   TBranch        *b_Kplus_ProbNNk_pidcorr_default;   //!
   TBranch        *b_Kplus_ProbNNk_pidstat_default;   //!
   TBranch        *b_Kplus_ProbNNk_pidmcstat_default;   //!
   TBranch        *b_Kplus_ProbNNk_pidcorr_syst1;   //!
   TBranch        *b_Kplus_ProbNNk_pidstat_syst1;   //!
   TBranch        *b_Kplus_ProbNNk_pidmcstat_syst1;   //!
   TBranch        *b_Kplus_ProbNNp_pidcorr_default;   //!
   TBranch        *b_Kplus_ProbNNp_pidstat_default;   //!
   TBranch        *b_Kplus_ProbNNp_pidmcstat_default;   //!
   TBranch        *b_Kplus_ProbNNp_pidcorr_syst1;   //!
   TBranch        *b_Kplus_ProbNNp_pidstat_syst1;   //!
   TBranch        *b_Kplus_ProbNNp_pidmcstat_syst1;   //!
...
#ifdef headfile_cxx
headfile::headfile(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/lzufs/home/lipl/lzufs/LHCb/deltaGd/samples/v0r3/mc/Bd2JpsiKstar/mc_Bd2JpsiKstar_2016_presel_pidcor.root/DecayTree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t headfile::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t headfile::LoadTree(Long64_t entry)
{
...
void headfile::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Kstar_MC_MOTHER_ID", &Kstar_MC_MOTHER_ID, &b_Kstar_MC_MOTHER_ID);
   fChain->SetBranchAddress("Kstar_MC_MOTHER_KEY", &Kstar_MC_MOTHER_KEY, &b_Kstar_MC_MOTHER_KEY);
   fChain->SetBranchAddress("Kstar_MC_GD_MOTHER_ID", &Kstar_MC_GD_MOTHER_ID, &b_Kstar_MC_GD_MOTHER_ID);
   fChain->SetBranchAddress("Kstar_MC_GD_MOTHER_KEY", &Kstar_MC_GD_MOTHER_KEY, &b_Kstar_MC_GD_MOTHER_KEY);
   ...
   fChain->SetBranchAddress("Kplus_ProbNNpi_pidcorr_default", &Kplus_ProbNNpi_pidcorr_default, &b_Kplus_ProbNNpi_pidcorr_default);
   fChain->SetBranchAddress("Kplus_ProbNNpi_pidstat_default", &Kplus_ProbNNpi_pidstat_default, &b_Kplus_ProbNNpi_pidstat_default);
   fChain->SetBranchAddress("Kplus_ProbNNpi_pidmcstat_default", &Kplus_ProbNNpi_pidmcstat_default, &b_Kplus_ProbNNpi_pidmcstat_default);
   fChain->SetBranchAddress("Kplus_ProbNNpi_pidcorr_syst1", &Kplus_ProbNNpi_pidcorr_syst1, &b_Kplus_ProbNNpi_pidcorr_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNpi_pidstat_syst1", &Kplus_ProbNNpi_pidstat_syst1, &b_Kplus_ProbNNpi_pidstat_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNpi_pidmcstat_syst1", &Kplus_ProbNNpi_pidmcstat_syst1, &b_Kplus_ProbNNpi_pidmcstat_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNk_pidcorr_default", &Kplus_ProbNNk_pidcorr_default, &b_Kplus_ProbNNk_pidcorr_default);
   fChain->SetBranchAddress("Kplus_ProbNNk_pidstat_default", &Kplus_ProbNNk_pidstat_default, &b_Kplus_ProbNNk_pidstat_default);
   fChain->SetBranchAddress("Kplus_ProbNNk_pidmcstat_default", &Kplus_ProbNNk_pidmcstat_default, &b_Kplus_ProbNNk_pidmcstat_default);
   fChain->SetBranchAddress("Kplus_ProbNNk_pidcorr_syst1", &Kplus_ProbNNk_pidcorr_syst1, &b_Kplus_ProbNNk_pidcorr_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNk_pidstat_syst1", &Kplus_ProbNNk_pidstat_syst1, &b_Kplus_ProbNNk_pidstat_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNk_pidmcstat_syst1", &Kplus_ProbNNk_pidmcstat_syst1, &b_Kplus_ProbNNk_pidmcstat_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNp_pidcorr_default", &Kplus_ProbNNp_pidcorr_default, &b_Kplus_ProbNNp_pidcorr_default);
   fChain->SetBranchAddress("Kplus_ProbNNp_pidstat_default", &Kplus_ProbNNp_pidstat_default, &b_Kplus_ProbNNp_pidstat_default);
   fChain->SetBranchAddress("Kplus_ProbNNp_pidmcstat_default", &Kplus_ProbNNp_pidmcstat_default, &b_Kplus_ProbNNp_pidmcstat_default);
   fChain->SetBranchAddress("Kplus_ProbNNp_pidcorr_syst1", &Kplus_ProbNNp_pidcorr_syst1, &b_Kplus_ProbNNp_pidcorr_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNp_pidstat_syst1", &Kplus_ProbNNp_pidstat_syst1, &b_Kplus_ProbNNp_pidstat_syst1);
   fChain->SetBranchAddress("Kplus_ProbNNp_pidmcstat_syst1", &Kplus_ProbNNp_pidmcstat_syst1, &b_Kplus_ProbNNp_pidmcstat_syst1);
...
void headfile::Show(Long64_t entry)
{
...
Int_t headfile::Cut(Long64_t entry)
{
