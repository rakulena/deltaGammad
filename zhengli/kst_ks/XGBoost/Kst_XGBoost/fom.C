...
void fom() {
    ...
    for (const auto& year : years) {
        TString inputDataPath = Form("/lzufs/user/zhanghy/Sample/Train/Bd2JpsiKstar_data_%s_BDT.root", year.Data());
        TString inputMCPath = Form("/lzufs/user/zhanghy/Sample/Train/Bd2JpsiKstar_mc_%s_BDT.root", year.Data());
        ...
        TString outputPlotPath = Form("/lzufs/user/zhanghy/kst_ks/Kst_XGBoost/fom/fom%s.png", year.Data());
